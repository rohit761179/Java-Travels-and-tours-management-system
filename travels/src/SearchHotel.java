...
public class SearchHotel extends JFrame implements ActionListener
{
	...
	SearchHotel()
	{
	    ...
	    ln=new JLabel("Search Hotel");
	    ln.setFont(new Font("Times New Roman",Font.BOLD,25));
	    ln.setForeground(Color.blue);
	    ln.setBounds(300,30,300,40);
            jf.setResizable(true);
                jf.setLayout(new FlowLayout());
                jf.setContentPane(new JLabel(new ImageIcon("C:\\Users\\DELL\\Documents\\NetBeansProjects\\travels\\src\\travels\\sshotel.jpg")));
  ...
  l4.setBounds(50,220,200,25);
   ...
   jf.add(l6);
        ...
        b0 = new JButton("Search",new ImageIcon("C:\\Users\\DELL\\Documents\\NetBeansProjects\\travels\\src\\travels\\open.png"));
        b0.setBounds(150,330,110,35);b0.setToolTipText("click to search hotel details");
 ...
 public void actionPerformed(ActionEvent ae)
  {
	  ...
	  {//fetch
              ...
              try
	      {
	        ...
	        {
		    JOptionPane.showMessageDialog(this,"Please enter hotel name or ratings !","Warning!!!",JOptionPane.WARNING_MESSAGE);
	        }
	        else
	        {
	         int foundrec = 0;
