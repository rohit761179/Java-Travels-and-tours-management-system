...
public class DeleteHotel extends JFrame implements ActionListener
{
	...
	DeleteHotel()
	{
	    ...
	    ln=new JLabel("Delete Hotel");
	    ln.setFont(new Font("Times New Roman",Font.BOLD,25));
	    ln.setForeground(Color.white);
	    ln.setBounds(510,30,350,40);
            jf.setResizable(true);
                jf.setLayout(new FlowLayout());
                jf.setContentPane(new JLabel(new ImageIcon("C:\\Users\\DELL\\Documents\\NetBeansProjects\\travels\\src\\travels\\hotel.jpg")));
  ...
  l4.setBounds(50,220,200,25);
   ...
   jf.add(l6);
		...
		b1.setBounds(300,330,110,35);b1.setToolTipText("click to delete bus details");
 ...
 public void actionPerformed(ActionEvent ae)
  {
	  ...
	  {//delete
		...
		con=DriverManager.getConnection("jdbc:mysql://localhost:3306/tours","root","root123");
		System.out.println("Connected to database.");
	    ps=con.prepareStatement("delete from hotel where hname='"+t1.getText()+"' or hrating='"+t2.getText()+"'");
	    ps.executeUpdate();
