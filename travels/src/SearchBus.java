...
public class SearchBus extends JFrame implements ActionListener
{
	...
	SearchBus()
	{
	    ...
	    ln.setBounds(300,30,300,40);
             ...
             jf.setResizable(true);
                ...
                jf.setContentPane(new JLabel(new ImageIcon("C:\\Users\\DELL\\Documents\\NetBeansProjects\\travels\\src\\travels\\updatebus.jpg")));
   ...
   l4.setBounds(50,220,200,25);
        ...
        b0.setBounds(150,330,110,35);b0.setToolTipText("click to search bus details");
		...
		b2.setBounds(450,330,110,35);b2.setToolTipText("click to view all bus details");
